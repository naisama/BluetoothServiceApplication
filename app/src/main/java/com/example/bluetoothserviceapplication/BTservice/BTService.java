...
public class BTService extends Service {
    ...
    //TODO device o BTdevice?
    public static Device device = null;

    @Override
    public void onCreate() {
        Log.d("BTService", "Service started");
        super.onCreate();
    }

    @Override
    public IBinder onBind(Intent intent) {
        mHandler = ((MyApplicationSingleton) getApplication()).getHandler();
        return mBinder;
    }
    ...
    /// SIMILAR AL METODO connect(Bluetooth device), es decir se le pasa un "device de BT" seleccionado al que queremos conectarnos
